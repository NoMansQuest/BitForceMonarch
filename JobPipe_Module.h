...
// This is the SCQ
volatile char	__inprocess_SCQ_midstate[TOTAL_SUBCHIPS_PER_BUS][32];
volatile char	__inprocess_SCQ_blockdata[TOTAL_SUBCHIPS_PER_BUS][16];
volatile char	__inprocess_SCQ_chip_processing[TOTAL_SUBCHIPS_PER_BUS];
